    ...
    <div style={{ background: P.bg, minHeight: '100vh', fontFamily: 'var(--font-inter), -apple-system, sans-serif' }}>
      ...
      <nav style={{
        ...
        <a href="/" style={{ display: 'flex', alignItems: 'center', gap: '9px', textDecoration: 'none' }}>
          <Image src="/assets/logo-mark.png" alt="Somenta" width={26} height={26} style={{ objectFit: 'contain', filter: 'brightness(0) saturate(100%) invert(52%) sepia(48%) saturate(632%) hue-rotate(346deg) brightness(96%) contrast(92%)' }} />
