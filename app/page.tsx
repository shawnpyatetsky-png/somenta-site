...
const HERO_QUOTES = [
  ...
  { quote: '"It has made me want to be a more compassionate person."', name: 'Evan', role: 'Founding Member' },
]
  ...
  return (
    <nav className="np-nav-inner" style={{
      ...
      >
        ...
        <img src="/assets/logo-mark.png" alt="Somenta" style={{ height: 26, width: 26, objectFit: 'contain', filter: 'brightness(0) saturate(100%) invert(52%) sepia(48%) saturate(632%) hue-rotate(346deg) brightness(96%) contrast(92%)' }} />
              ...
              {(isTuesday || isThursday || isFriday || isSaturday) && (() => {
                ...
                return (
                  <div key={`content-${openDay}`} className="np-day-in np-sched-two-col" style={{ width: '100%', height: '100%', display: 'grid', gridTemplateColumns: '55% 45%' }}>
                    ...
                    <div className="np-sched-photo" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1.5rem 1rem 0' }}>
                      <div className="np-sched-img" style={PHOTO_CARD_STYLE}>
                        <Image src={cardImg} alt="" fill loading="eager" sizes="185px" style={{ objectFit: 'cover', objectPosition: isSaturday ? '90% center' : 'center center', filter: 'sepia(0.25) saturate(0.82)' }} />
                      </div>
                    </div>
                  </div>
                )
