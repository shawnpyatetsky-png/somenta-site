...
// Rust emphasis — the one relief phrase per break screen a skimmer's eye lands on
...
const Q4_BREAK: Record<string, { heading: string; body: React.ReactNode; quote: string; attribution: string }> = {
  ...
  B: {
    ...
    body: <>You don&rsquo;t need to fix everything at once. The most effective integration happens when you have <Hi>a safe place to land</Hi>, a guided rhythm and a supportive community to help you gently manage those emotions.</>,
  ...
  C: {
    ...
    body: <>When your old relationships no longer align with who you are becoming, that gap can leave you feeling deeply unseen. The most effective way to bridge that gap is finding a safe container of peers who actually get it, so you <Hi>never have to translate, hide, or defend</Hi> your journey.</>,
...
const Q7_BREAK: Record<string, { heading: string; body1: string; body2: React.ReactNode }> = {
  A: {
    ...
    body2: <>You need a space to actually put that therapy into practice — a place where your experience is <Hi>a shared reality</Hi>.</>,
  },
  B: {
    ...
    body2: <>The process of integration requires an emotionally safe space where you can share vulnerable, unfiltered thoughts with a community that <Hi>immediately understands</Hi> the depth of your journey.</>,
  },
  C: {
    ...
    body2: <>But there is a profound, immediate relief that happens the moment you share your experience and hear someone else say, <Hi>&ldquo;I know exactly how that feels.&rdquo;</Hi> We&rsquo;re built to be that space for you.</>,
  },
  D: {
