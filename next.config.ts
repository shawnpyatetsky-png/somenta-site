...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Intake form — one form, two clean links, each ending on its own calendar
      { source: '/call', destination: '/intake?c=s', permanent: false },
      { source: '/connect', destination: '/intake?c=j', permanent: false },
